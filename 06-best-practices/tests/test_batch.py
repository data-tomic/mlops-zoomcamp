...
from homework_q1 import prepare_data
...
def test_prepare_data():
    ...
    actual_df = prepare_data(df_input, categorical)
    ...
    # Проверка
    # Сравниваем словари, чтобы не зависеть от типов данных (которые могут отличаться)
